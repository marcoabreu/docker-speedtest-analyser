...
class SpeedTest(object):
    ...
    DOWNLOAD_FILES = [
        '/100MB.zip',
        # https://speedcheck-fra.kabeldeutschland.de.prod.hosts.ooklaserver.net:8080/download?nocache=8f9a2283-2195-4645-acbf-0b3e6876d693&size=25000000
    ]
    ...
    def download(self):
        total_downloaded = 0
        connections = [
            self.connect('speedtest.tele2.net') for _ in range(self.runs)
        ]
